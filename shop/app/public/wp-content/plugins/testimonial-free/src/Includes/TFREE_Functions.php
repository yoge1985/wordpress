...
class TFREE_Functions {
	...
	public function admin_menu() {
		$landing_page = 'https://shapedplugin.com/real-testimonials/pricing/?ref=1';
		add_submenu_page(
		...
		<section class="tf-help upgrade">
			...
			<div class="container">
				<div class="upgrade-pro">
					...
					<div class="pro-btn">
						<a href="https://shapedplugin.com/real-testimonials/pricing/?ref=1" target="_blank">Upgrade To Pro Now</a>
					</div>
				</div>
			</div>
		</section>
