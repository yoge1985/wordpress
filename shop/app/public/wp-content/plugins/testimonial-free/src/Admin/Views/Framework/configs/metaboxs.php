	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'     => __( 'To unlock more amazing Testimonial Layouts (Masonry, List, & Isotope), <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade To Pro!</b></a>.', 'testimonial-free' ),
			...
			array(
				'type'       => 'notice',
				'style'      => 'info',
				'content'    => __( 'To unlock the following ajax pagination settings for Grid, Masonry, & List layouts,<a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b> Upgrade To Pro!</b></a>', 'testimonial-free' ),
				'dependency' => array(
					'layout',
					'==',
					'grid',
