...
if ( ! class_exists( 'SPFTESTIMONIAL_Field_form_upper_section' ) ) {
	...
	<div class="sp-testimonial-features">
		...
		<p class="sp-testimonial-text-center"><a class="sp-testimonial-upgrade-btn" target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1">Upgrade To Real Testimonials Pro Now!</a></p>
